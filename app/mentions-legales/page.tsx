    ...
    <main>
      ...
      <section className="px-6 pt-28 pb-24" style={{ backgroundColor: "var(--paper)" }}>
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="font-display text-4xl mb-12" style={{ color: "var(--ink)" }}>Mentions légales</h1>

          <div className="space-y-10 text-sm font-light leading-relaxed" style={{ color: "var(--mid)" }}>
            <section>
              <h2 className="font-display text-xl mb-4" style={{ color: "var(--ink)" }}>Éditeur du site</h2>
              <p>
                <strong style={{ color: "var(--ink)" }}>Label Technology</strong><br />
            ...
            <section>
              <h2 className="font-display text-xl mb-4" style={{ color: "var(--ink)" }}>Hébergement</h2>
              <p>
                Ce site est hébergé par <strong style={{ color: "var(--ink)" }}>Vercel Inc.</strong><br />
            ...
            <section>
              <h2 className="font-display text-xl mb-4" style={{ color: "var(--ink)" }}>Propriété intellectuelle</h2>
              <p>
            ...
            <section>
              <h2 className="font-display text-xl mb-4" style={{ color: "var(--ink)" }}>Protection des données</h2>
              <p>
            ...
            <section>
              <h2 className="font-display text-xl mb-4" style={{ color: "var(--ink)" }}>Cookies</h2>
              <p>
            ...
            <section>
              <h2 className="font-display text-xl mb-4" style={{ color: "var(--ink)" }}>Liens externes</h2>
              <p>
