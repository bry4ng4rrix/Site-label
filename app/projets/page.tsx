...
export const metadata: Metadata = {
  ...
  description:
    "Découvrez les projets réalisés par Label Technology : développement web & mobile, call center B2B, marketing digital, digitalisation. 12 réalisations détaillées avec métriques.",
};
      ...
      <section className="relative min-h-[50vh] flex flex-col justify-center grid-bg px-6 pt-24 pb-16"
        ...
        <div className="relative max-w-7xl mx-auto w-full">
          ...
          <p className="text-white/60 text-lg font-light max-w-xl">
            12 projets sélectionnés. Filtrez par domaine.
